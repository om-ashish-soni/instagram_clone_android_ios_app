    ...
    <View>
      <View style={styles.container}>
        ...
        <Image
          ...
          source={{
            uri:
              "https://firebasestorage.googleapis.com/v0/b/instagram-clone-by-om-soni.appspot.com/o/logo.PNG?alt=media&token=79c9040c-cac3-46c7-8d7d-cc3e50928ece"
          }}
          resizeMode={"cover"}
        />
        <TextInput
        ...
        <View style={styles.button}>
          <Button title="Choose DP" onPress={pickDocument} />
        </View>
        <View style={styles.button}>
